...
public class BrowserJournalChapterHandler implements JournalChapterHandler {
    private final Map<String, JournalEntryProducer> entryMap = new HashMap<>();

    public void registerJournalEntry(String entryId, String htmlLikeText) {
        entryMap.put(entryId,
                new StaticJournalEntryProducer(Collections.singleton(HTMLLikeParser.parseHTMLLikeParagraph(null,
                        htmlLikeText))));
    }
