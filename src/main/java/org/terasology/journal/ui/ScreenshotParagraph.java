...
public class ScreenshotParagraph implements ParagraphData, ParagraphRenderable {

    private int iconSize = 205;
    private int indentAbove = 25;
    private int indentBelow = 5;
    private int iconSpacing = 3;
    private ItemIcon[] icons;

    public ScreenshotParagraph(Prefab[] itemPrefabs, Block[] blocks) {
    ...
    @Override
    public void renderContents(Canvas canvas, Vector2i startPos, ContainerRenderSpace containerRenderSpace, int leftIndent,
                               int rightIndent, ParagraphRenderStyle defaultStyle, HorizontalAlign horizontalAlign,
    ...
    @Override
    public int getPreferredContentsHeight(ParagraphRenderStyle defaultStyle, int yStart, ContainerRenderSpace containerRenderSpace,
                                          int sideIndents) {
